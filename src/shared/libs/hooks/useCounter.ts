 ...
 * @param {number} [min] - Minimum value for the counter.
 ...
 */
export function useCounter(initialValue?: number, min: number = -1e9, max: number = 1e9): UseCounterOutput {
